...
<head>
  ...
  <title>Manajemen SPP | Login</title>
...
<body class="hold-transition login-page" style="background-image: url(https://th.bing.com/th/id/R.d24b9d4df682f8d6dbb890a4ec9476c9?rik=xdQizktwYHeV%2bw&riu=http%3a%2f%2fwallpapercave.com%2fwp%2fciVSiJu.jpg&ehk=0ApoRmghfbLRAm3DDn8BMctEj9%2femLYRVEiqAOpO8Ws%3d&risl=&pid=ImgRaw&r=0)">
<div class="login-box" style="margin-bottom: 20vh;">
  <div class="login-logo">
    <img src="{{ asset('templates/backend/AdminLTE-3.1.0') }}/dist/img/logospp.png" alt="AdminLTE Logo" style="height: 100px"><br>
  </div>
  <!-- /.login-logo -->
  <div class="card">
